 ...
 */
function buildPack({ agentCount = 26, skillCount = 22, extraPrimary = false, dupAgentName = false, dupSkillName = false } = {}) {
...
test('validatePack passes a healthy 26-agent / 22-skill pack with zero violations', () => {
