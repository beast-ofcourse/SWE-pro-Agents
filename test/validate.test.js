 ...
 */
function buildPack({ agentCount = 26, skillCount = 26, extraPrimary = false, dupAgentName = false, dupSkillName = false } = {}) {
...
test('validatePack passes a healthy 26-agent / 26-skill pack with zero violations', () => {
