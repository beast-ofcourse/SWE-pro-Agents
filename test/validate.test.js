 ...
 */
function buildPack({ agentCount = 26, skillCount = 24, extraPrimary = false, dupAgentName = false, dupSkillName = false } = {}) {
...
test('validatePack passes a healthy 26-agent / 24-skill pack with zero violations', () => {
